...
type CopyTextProps = {
  editorInputContainerRef: React.RefObject<HTMLElement>;
};

const CopyText: React.FC<CopyTextProps> = ({ editorInputContainerRef }) => {
  const handleCopyToClipboard = async () => {
    const divElementsWithText =
      editorInputContainerRef.current?.querySelectorAll(".ce-paragraph");
